            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              ...
              <div>
                ...
                <p className="text-gray-200 mb-6">
                  ...
                  functionality to create architectural masterpieces.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="text-gray-200 hover:text-white transition-colors">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start space-x-3">
                    ...
                    <span className="text-gray-200">
                      Sco 8, Green Field Market, opposite Sector 7, DD Colony,
                  ...
                  <li className="flex items-center space-x-3">
                    ...
                    <a
                      href="mailto:info@anshularchitects.com"
                      className="text-gray-200 hover:text-white transition-colors"
                    >
